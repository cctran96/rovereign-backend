...
spearman = Character.create(role: "spearman", base_stats: {hp: 100, mp: 50, str: 100, dex: 25, int: 25, spd: 25, def: 25})
crusader = Character.create(role: "crusader", base_stats: {hp: 500, mp: 250, str: 500, dex: 125, int: 125, spd: 125, def: 125})
hero = Character.create(role: "hero", base_stats: {hp: 1000, mp: 500, str: 1000, dex: 250, int: 250, spd: 250, def: 250})
