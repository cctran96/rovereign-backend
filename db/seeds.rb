...
vang_satyr = Monster.create(name: "vang_satyr", base_stats: {hp: 10, mp: 0, str: 10, dex: 10, int: 10, cri: 2, spd: 10, def: 10}, base_gold: 100, base_exp: 40, map: primeval_forest)
owr_satyr = Monster.create(name: "owr_satyr", base_stats: {hp: 20, mp: 0, str: 20, dex: 20, int: 20, cri: 2, spd: 20, def: 20}, base_gold: 150, base_exp: 80, map: wychwood)
santri_satyr = Monster.create(name: "santri_satyr", base_stats: {hp: 30, mp: 0, str: 30, dex: 30, int: 30, cri: 2, spd: 30, def: 30}, base_gold: 200, base_exp: 120, map: twilight_woods)
maro_minotaur = Monster.create(name: "maro_minotaur", base_stats: {hp: 40, mp: 0, str: 40, dex: 40, int: 40, cri: 10, spd: 40, def: 40}, base_gold: 250, base_exp: 200, map: tranquil_falls)
griza_minotaur = Monster.create(name: "griza_minotaur", base_stats: {hp: 50, mp: 0, str: 50, dex: 50, int: 50, cri: 10, spd: 50, def: 50}, base_gold: 300, base_exp: 240, map: twilight_woods)
marmoreal_minotaur = Monster.create(name: "marmoreal_minotaur", base_stats: {hp: 60, mp: 0, str: 60, dex: 60, int: 60, cri: 10, spd: 60, def: 60}, base_gold: 350, base_exp: 280, map: hercule_peak)
gidgee_golem = Monster.create(name: "gidgee_golem", base_stats: {hp: 70, mp: 0, str: 70, dex: 70, int: 70, cri: 10, spd: 70, def: 70}, base_gold: 400, base_exp: 360, map: nix_village)
stone_golem = Monster.create(name: "stone_golem", base_stats: {hp: 80, mp: 0, str: 80, dex: 80, int: 80, cri: 10, spd: 80, def: 80}, base_gold: 450, base_exp: 400, map: arctic_forest)
jade_golem = Monster.create(name: "jade_golem", base_stats: {hp: 90, mp: 0, str: 90, dex: 90, int: 90, cri: 10, spd: 90, def: 90}, base_gold: 500, base_exp: 440, map: pere_noel)
arcane_wraith = Monster.create(name: "arcane_wraith", base_stats: {hp: 100, mp: 0, str: 100, dex: 100, int: 100, cri: 10, spd: 100, def: 100}, base_gold: 550, base_exp: 520, map: elven_hideout)
occult_wraith = Monster.create(name: "occult_wraith", base_stats: {hp: 110, mp: 0, str: 110, dex: 110, int: 110, cri: 10, spd: 110, def: 110}, base_gold: 600, base_exp: 560, map: arachnids_den)
pyro_wraith = Monster.create(name: "pyro_wraith", base_stats: {hp: 120, mp: 0, str: 120, dex: 120, int: 120, cri: 10, spd: 120, def: 120}, base_gold: 650, base_exp: 600, map: spectral_grave)
...
Item.create(name: "pimple_berry", description: "A pink berry with purple spots that resemble pimples.")
Item.create(name: "nympha_berry", description: "A green berry that resembles the immature form of some insects.")
Item.create(name: "renal_berry", description: "A yellow berry known to cause kidney stones when ingested without the removal of its toxins.")
Item.create(name: "cerebral_berry", description: "A blue berry with wrinkles that resemble gyri of the brain.")
Item.create(name: "pity_berry", description: "A droopy red berry that causes one to feel sorrow and grief if ingested raw.")
Item.create(name: "lilium", description: "A true lily that has been blessed by elves.")
Item.create(name: "zinnia", description: "A green sunflower found in scorching hot grasslands.")
Item.create(name: "mandrake", description: "A man-shaped plant known to put people to sleep.")
Item.create(name: "hydrangea", description: "A magical plant that grows nears roaring waterfalls.")
Item.create(name: "agaric", description: "A mushroom that has evolved to produce blood.")
Item.create(name: "monster_eyball", description: "A monster's eyeball preserved in the monster's own blood.")
Item.create(name: "monster_claw", description: "A monster's claw that has been cleansed.")
Item.create(name: "monster_skull", description: "A monster's skull that has been cleansed.")
Item.create(name: "lolihop", description: "A large poisonous frog that resides in damp swamps.")
Item.create(name: "scarab", description: "A large golden beetle that originates from ancient Egypt.")
