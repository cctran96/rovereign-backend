...
nympha_berry = Item.create(name: "nympha_berry", description: "A green berry that resembles the immature form of some insects.", cost: 100)
renal_berry = Item.create(name: "renal_berry", description: "A yellow berry known to cause kidney stones when ingested without the removal of its toxins.", cost: 100)
pimple_berry = Item.create(name: "pimple_berry", description: "A pink berry with purple spots that resemble pimples.", cost: 100)
cerebral_berry = Item.create(name: "cerebral_berry", description: "A blue berry with wrinkles that resemble gyri of the brain.", cost: 100)
pity_berry = Item.create(name: "pity_berry", description: "A droopy red berry that causes one to feel sorrow and grief if ingested raw.", cost: 100)
range_potion = Item.create(name: "range_potion", description: "A concentrated potion made out of nympha berries. It temporarily increases the user's dexterity by 10.", effect: {increase: {dex: 10}, craft: ["5 nympha_berry"]}, cost: 500)
strength_potion = Item.create(name: "strength_potion", description: "A concentrated potion made out of renal berries. It temporarily increases the user's strength by 10.", effect: {increase: {str: 10}, craft: ["5 renal_berry"]}, cost: 500)
magic_potion = Item.create(name: "magic_potion", description: "A concentrated potion made out of pimple berries. It temporarily increases the user's intelligence by 10.", effect: {increase: {int: 10}, craft: ["5 pimple_berry"]}, cost: 500)
mana_potion = Item.create(name: "mana_potion", description: "A concentrated potion made out of cerebral berries. It heals the user's mana by 30.", effect: {increase: {mp: 30}, craft: ["5 cerebral_berry"]}, cost: 500)
health_potion = Item.create(name: "health_potion", description: "A concentrated potion made out of pity berries. It heals the user's health by 30.", effect: {increase: {hp: 30}, craft: ["5 pity_berry"]}, cost: 500)
zinnia = Item.create(name: "zinnia", description: "A green sunflower found in scorching hot grasslands.", cost: 200)
mandrake = Item.create(name: "mandrake", description: "A man-shaped plant known to put people to sleep.", cost: 200)
lilium = Item.create(name: "lilium", description: "A true lily that has been blessed by elves.", cost: 200)
hydrangea = Item.create(name: "hydrangea", description: "A magical plant that grows nears roaring waterfalls.", cost: 200)
agaric = Item.create(name: "agaric", description: "A mushroom that has evolved to produce blood.", cost: 200)
distilled_range_potion = Item.create(name: "distilled_range_potion", description: "A refined potion made out of nympha berries and zinnias. It temporarily increases the user's dexterity by 30.", effect: {increase: {dex: 30}, craft: ["10 nympha_berry, 5 zinnia"]}, cost: 2000)
distilled_strength_potion = Item.create(name: "distilled_strength_potion", description: "A refined potion made out of renal berries and mandrakes. It temporarily increases the user's strength by 30.", effect: {increase: {str: 30}, craft: ["10 renal_berry, 5 mandrake"]}, cost: 2000)
distilled_magic_potion = Item.create(name: "distilled_magic_potion", description: "A refined potion made out of pimple berries and liliums. It temporarily increases the user's intelligence by 30.", effect: {increase: {int: 30}, craft: ["10 pimple_berry, 5 lilium"]}, cost: 2000)
distilled_mana_potion = Item.create(name: "distilled_mana_potion", description: "A refined potion made out of cerebral berries and hydrangeas. It heals the user's mana by 70.", effect: {increase: {mp: 70}, craft: ["10 cerebral_berry, 5 hydrangea"]}, cost: 2000)
distilled_health_potion = Item.create(name: "distilled_health_potion", description: "A refined potion made out of pity berries and agarics. It heals the user's health by 70.", effect: {increase: {hp: 70}, craft: ["10 pity_berry, 5 agaric"]}, cost: 2000)
lolihop = Item.create(name: "lolihop", description: "A large poisonous frog that resides in damp swamps.", cost: 1000)
scarab = Item.create(name: "scarab", description: "A large golden beetle that originates from ancient Egypt.", cost: 1000)
monster_eyeball = Item.create(name: "monster_eyeball", description: "A monster's eyeball preserved in the monster's own blood.", cost: 1000)
monster_claw = Item.create(name: "monster_claw", description: "A monster's claw that has been cleansed.", cost: 1000)
monster_skull = Item.create(name: "monster_skull", description: "A monster's skull that has been cleansed.", cost: 1000)
elixir_of_acuity = Item.create(name: "elixir_of_acuity", description: "A purified potion made out of nympha berries, zinnias, and a lolihop. It temporarily increases the user's dexterity by 50.", effect: {increase: {dex: 50}, craft: ["20 nympha_berry, 10 zinnia, 1 lolihop"]}, cost: 5000)
elixir_of_necromancy = Item.create(name: "elixir_of_necromancy", description: "A purified potion made out of pimple berries, liliums, and a monster eyeball. It temporarily increases the user's intelligence by 50.", effect: {increase: {int: 50}, craft: ["20 pimple_berry, 10 lilium, 1 monster_eyeball"]}, cost: 5000)
elixir_of_might = Item.create(name: "elixir_of_might", description: "A purified potion made out of renal berries, mandrakes, and a scarab. It temporarily increases the user's strength by 50.", effect: {increase: {str: 50}, craft: ["20 renal_berry, 10 mandrake, 1 scarab"]}, cost: 5000)
elixir_of_enchantment = Item.create(name: "elixir_of_enchantment", description: "A purified potion made out of cerebral berries, hydrangeas, and a monster claw. It heals the user's mana by 150.", effect: {increase: {mp: 150}, craft: ["20 cerebral_berry, 10 hydrangea, 1 monster_claw"]}, cost: 5000)
elixir_of_vigor = Item.create(name: "elixir_of_vigor", description: "A purified potion made out of pity berries, agarics, and a monster skull. It heals the user's health by 150.", effect: {increase: {hp: 150}, craft: ["20 pity_berry, 10 agaric, 1 monster_skull"]}, cost: 5000)
