...
scream = Skill.create(name: "scream", effect: {debuff: {def: "10%"}}, description: "Lets out a thunderous scream, lowering the enemy's defense by 10%.", level: 3, character: spearman)
poison_jab = Skill.create(name: "poison_jab", effect: {attack: {damage: 20}}, description: "Strikes the enemy with poison.", level: 5, character: spearman)
...
electroball = Skill.create(name: "electroball", effect: {attack: {damage: 10}}, description: "Unleashes a ball of electricity towards the enemy.", level: 1, character: magician)
magic_buff = Skill.create(name: "magic_buff", effect: {buff: {int: "10%"}}, description: "Increases the player's intelligence by 10%.", level: 2, character: magician)
flee = Skill.create(name: "flee", effect: {chance: {passive: "10%"}}, description: "Gives the player a 10% chance of escaping from battle when their health drops below 10%.", level: 3, character: magician)
fireball = Skill.create(name: "fireball", effect: {attack: {damage: 20}}, description: "Unleashes a ball of fire towards the enemy.", level: 5, character: magician)
...
sneak = Skill.create(name: "sneak", effect: {passive: {damage: 10}}, description: "The player has a 20% chance of sneaking in a hit on the enemey before the start of the battle.", level: 1, character: hunter)
range_buff = Skill.create(name: "range_buff", effect: {buff: {dex: "10%"}}, description: "Increases the player's dexterity by 10%.", level: 2, character: hunter)
crybaby = Skill.create(name: "crybaby", effect: {debuff: {spd: "50%"}}, description: "Pretend to cry, dropping the enemy's guard and lowering their speed by 50%.", level: 3, character: hunter)
holy_shot = Skill.create(name: "holy_shot", effect: {attack: {damage: 20}}, description: "Fire a ball of spiritual energy.", level: 5, character: hunter)
